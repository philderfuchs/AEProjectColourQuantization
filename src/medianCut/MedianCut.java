...
public class MedianCut implements ColorQuantizer {
	...
	public HashSet<Pixel> quantizeWithFilter(Histogram histogram,
		...
		ArrayList<Cube> cubeList = this.medianCut(histogram,
				preFilterColorCount);
		...
		PaletteFilter paletteFiler = new PaletteFilter(this.count);
